...
**UwULogs** is an addon that displays competitive performance rankings directly within the game. It provides a quick and easy way to check if a player appears in the **UwU Logs Top 1000 rankings** based on data from (https://uwu-logs.xyz).
...
4. View ranking, percentile, and max DPS by mouseover a player.
   ...
   <img width="390" height="210" alt="image" src="https://github.com/user-attachments/assets/f5c50b11-8e93-40a6-9498-72f53a2659cf" />
...
4. Run `UwU.exe` you will see a couple of options:
      ...
      '3' You can remove those combatlog.txt in your Log folder  
      '4' Launch the game  
